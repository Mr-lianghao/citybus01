...
<script type="text/javascript">
	function ckNum(){
		...
		if(!isNaN(baikuang)){
			...
			if(baikuang>totalPage){
			 ...
			 window.location.href="${pageContext.request.contextPath}/front/newsAction_list?page.pageNo="+baikuang;
			}
		}else{
			alert("请输入数字");
		}
	...
	function fsubmit(){
		var keyname = document.getElementById("keyname").value;
		 window.location.href="${pageContext.request.contextPath}/front/newsAction_list?newstitle="+keyname;
	}
													...
													<TD vAlign=top width=220 bgColor=#efefef height=341>
														<TABLE cellSpacing=0 cellPadding=0 width=199 align=center
															...
															<TBODY>
																...
																<TR>
																	<TD vAlign=bottom align=middle height=30>
																		<IMG height=18 src=" ${pageContext.request.contextPath }/images/main/gif101.gif" width=174
																				border=0>
																...
																<TR>
																	<TD vAlign=bottom align=middle height=30>
																		<IMG height=18 src="${pageContext.request.contextPath }/images/main/gif242.gif" width=174
																				border=0>
																				...
																				<c:forEach items="${results }" var="news">
																						<TR>
																							...
																							<TD class=xuxianxia height=25>
																								<A
																									href="${pageContext.request.contextPath }/front/newsAction_view?id=${news.id}"
																									>${news.newstitle}</A>&nbsp;&nbsp;
																							...
																							<TBODY>
																								<TR>
																									<TD vAlign=center align=middle>
																										<SPAN >第${pageNo}/ ${totalPage}页 每页 ${pageSize}条 <A
																											class=a01
																											href="${pageContext.request.contextPath }/front/newsAction_list">首页</A>
																											<A class=a01
																											href="${pageContext.request.contextPath }/front/newsAction_list?page.pageNo=${pageNo==1?1:pageNo-1}">上一页</A>
																											<A class=a01
																											href="${pageContext.request.contextPath }/front/newsAction_list?page.pageNo=${pageNo==totalPage?totalPage:pageNo+1}">下一页</A>
																											<A class=a01
																											href="${pageContext.request.contextPath }/front/newsAction_list?page.pageNo=${totalPage}">末页</A>,转到:
																										</SPAN>
																										...
																										<INPUT
																											...
																											<input type="hidden" id="totalP" value="${totalPage}"/>
																									</TD>
																								</TR>
																							</TBODY>
																						</TABLE>
